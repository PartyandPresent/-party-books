...
export const BOOKS: Book[] = [
...

  {
    ...
    accordionContent: {
      ...
      howPersonalized: "Every copy is personalized with your child's name and a custom illustrated character made from their photo. You can also add an optional dedication message on the first page. The final spread is a keepsake page featuring the big sibling's name, the new baby's name, and birth date.",
      sizeQuality: 'Available as a softcover in 5.5" × 5.5", 8" × 8", or 8" × 11", and as a hardcover in 8" × 8", 11" × 11", or 8" × 11". Printed on premium paper for vivid, long-lasting color.',
    },
  },
...

  {
    ...
    accordionContent: {
      ...
      howPersonalized: "Every copy is personalized with your child's name and a custom illustrated character made from their photo. You can also add an optional dedication message on the first page.",
      sizeQuality: 'Available as a softcover in 5.5" × 5.5", 8" × 8", or 8" × 11", and as a hardcover in 8" × 8", 11" × 11", or 8" × 11". Printed on premium paper for vivid, long-lasting color.',
    },
  },

  {
    ...
    highlights: [
      ...
      "14 pages of God's promises, beautifully illustrated in 3D storybook style",
    ...
    accordionContent: {
      ...
      howPersonalized: "Every copy is personalized with your child's name and a custom illustrated character made from their photo, placed into every illustrated scene. You can also add an optional dedication message on the first page. The final spread is a personal keepsake with their name, a space for a signature, and a date.",
      sizeQuality: 'Available as a softcover in 5.5" × 5.5", 8" × 8", or 8" × 11", and as a hardcover in 8" × 8", 11" × 11", or 8" × 11". Printed on premium paper for vivid, long-lasting color.',
    },
  },
