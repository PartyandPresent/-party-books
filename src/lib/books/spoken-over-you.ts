  ...
  pages: [
    ...
    // ── Page 00 — Cover ───────────────────────────────────────────────────────
    {
      ...
      characterActionPrompt:
        'Scene: The Child is holding both hands of God — one hand on each side of the Child. God\'s presence is behind the Child, slightly faded by a warm golden light. BOTH of God\'s hands must be clearly visible, one on the left side and one on the right side of the Child. The Child looks happy and loved, guided from behind. Place the character and scene on the RIGHT side of the canvas only — never in the center.\n\nFRAMING — CRITICAL: This is a HALF-BODY PORTRAIT. Show the character from the face down to the waist ONLY. Legs and feet must NOT be visible. The frame cuts off at the child\'s midsection/waist.\n\nVERTICAL POSITION — CRITICAL: The character must be positioned LOW in the frame. The top of the child\'s head should begin at approximately 35–40% down from the top of the canvas. Do NOT place the character at the very top — leave clear empty space above the head for the title text.\n\nView: Zoom front facing view\nBackground: dramatic fade to all white color toward the LEFT side\n\nStyle: Premium stylized 3D children\'s storybook illustration. The character is sharply focused, while the environment fades into a softly blurred background. Use shallow depth of field, creamy bokeh, reduced background contrast, vibrant background colors, atmospheric haze. Soft diffused daylight, delicate highlights, gentle shadows, subtle rim light, balanced neutral-to-cool tones, no strong yellow tint. High-end cinematic 3D render, animated-feature quality, global illumination, subsurface skin scattering, volumetric lighting, smooth materials, realistic cloth and hair, clean composition, dreamy heartwarming atmosphere, 50mm lens, wide aperture, high resolution.',
      includesSenderCharacter: false,
      skipTextCollision: true,
      characterPlacement: { x: 1166, y: 365, width: 672, height: 862 },
      textBlocks: [
        {
