...
const FAQ_SECTIONS = [
  {
    ...
    questions: [
      ...
      },
      {
        ...
        a: "A clear, well-lit, front-facing photo. Avoid heavy filters, sunglasses, or hats. The better the photo, the closer the likeness — but if you're unsure, upload it and see how the preview looks.",
      },
    ],
  },
  {
  ...
  },
  {
    ...
    questions: [
      ...
      },
      {
        ...
        a: "Yes. A real person checks every illustration before it goes to print — for likeness, quality, and accuracy. If something isn't right, we fix it before it ships.",
      },
      {
